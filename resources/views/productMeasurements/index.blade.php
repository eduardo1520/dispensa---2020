...
{{--                        </div>--}}
                ...
                <div class="card-body">
                    <a href="#" class="btn btn-success btn-icon-split" data-toggle="modal" data-target=".modalProductMeasurements"  onclick=''>
...
<script src="{{ asset('js/product_measurements.js') }}" type="text/javascript"></script>
